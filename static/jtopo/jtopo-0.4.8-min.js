      ...
      return {
        ...
        getData: function(b, c) {
          ...
          function drawRoundedRect(rect, r, ctx, strokeStyle, fillStyle) {
            ...
            ctx.fillStyle = "transparent";   //选择油漆桶的颜色
            ctx.strokeStyle = strokeStyle || "#d1e5ff";
            ctx.fill();                 //确定填充
            ctx.stroke();
          }
          null != j && null != k ? this.setSize(b, c) : this.setSize(240, 158);
          ...
          if (a.childs.length > 0) {
            ...
            var rect = Rect(-g + 4, -h + 8, e.canvas.width * j - 8, e.canvas.height * k);
              drawRoundedRect(rect, 4, e, '#f2c939', '#f2c939');
        ...
        eventHandler: function(a, b, c) {
          ...
          if (d > c.params.x_star && d < c.params.x_end && e > c.params.y_star && e < c.params.y_end) {
      ...
      document.oncontextmenu = function() {
        ...
        this.dispatchEventToScenes = function(a, b) {
          if (0 != this.frames && (this.needRepaint = !0), 1 == this.eagleEye.visible && -1 != a.indexOf("mouse")) {
            var c = b.x,
              d = b.y;
            if (this.params && c > this.params.x_star && c < this.params.x_end && d > this.params.y_star && d < this.params.y_end) return void this.eagleEye.eventHandler(a, b, this)
          }
